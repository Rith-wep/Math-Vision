  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto flex w-full max-w-xl flex-col px-4 py-6">
        <Link
          to="/"
          className="inline-flex w-fit items-center rounded-full border border-[#22c55e]/20 bg-white px-4 py-2 text-sm font-medium text-[#22c55e] transition hover:bg-[#22c55e]/5"
        >
          Back to Home
        </Link>

        <section className="mt-5 rounded-[2rem] border border-[#22c55e]/15 bg-white p-6 text-center shadow-sm">
          ...
          <div className="mt-8 flex justify-center">
            ...
            >
              <div className="flex h-40 w-40 items-center justify-center overflow-hidden rounded-full border-[6px] border-[#22c55e]/15 bg-[#22c55e]/6 shadow-[0_20px_40px_rgba(34,197,94,0.14)]">
                <img src={avatarUrl} alt={displayName || user?.displayName || "Profile"} className="h-full w-full object-cover" />
              </div>
              <div className="absolute bottom-2 right-2 flex h-11 w-11 items-center justify-center rounded-full bg-[#22c55e] text-white shadow-lg transition group-hover:bg-[#16a34a]">
          ...
          <div className="mt-8 text-left">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3.5 text-base text-slate-900 outline-none transition focus:border-[#22c55e] focus:bg-white"
              />
